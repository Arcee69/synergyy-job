...
const JobBoard = () => {
  ...
  return (
    <div className='flex justify-between '>
        <div className='w-full lg:w-7/12 flex flex-col gap-6 lg:gap-[32px]' style={{width: '67.333333%'}}> {/* w-[669px] */}
            ...
            <div className='w-full gap-2 flex'>
                <div className='w-[249px] lg:w-[563px] bg-[#F0F0F0] justify-between px-[8px]  lg:h-[58px] flex items-center rounded-xl'>
                    <input 
                        name='search'
                        type='text'
                        placeholder='Search for a job'
                        className="outline-none font-mont bg-transparent lg:ml-[24px] text-sm lg:text-base font-medium "
                    />
                    <button className='w-[33px] h-[33px] lg:w-[42px] lg:h-[42px] bg-[#000709] rounded-lg flex items-center justify-center'>
                        <img src={Search} alt='search' />
                    </button>
                </div>
                <div onClick={() => setOpenFilter(true)} className='w-[79px] lg:w-[98px] cursor-pointer h-[58px] rounded-lg flex justify-center gap-[6px] lg:gap-[8px] items-center border border-[#1C1C1C1A]'>
                    <p className='text-[#1C1C1CE5] font-mont font-semibold text-[11px] lg:text-sm '>Filter</p>
                    <img src={Filter} alt='filter' />
                </div>
            </div>
            <div className='w-full flex flex-col gap-[8px]'>
                <p className='text-[#000709] text-xs lg:text-base font-mont font-semibold'>Handpicked For You</p>

                <div onClick={() => {navigate("/job-board/details"); window.scroll(0, 0)}} className='w-full p-4 lg:px-[20px] gap-[7px] cursor-pointer lg:py-[22px] border border-[#E3E7E8] rounded-lg flex flex-col bg-[#fff] '>
        ...
        <div className='w-4/12 lg:flex flex-col gap-6 hidden ' style={{width:'29%'}}> {/* w-[332px] */}
            <div className='w-[308px] h-[355px] bg-[#fff] rounded-[10px] flex flex-col gap-4 items-center justify-center'>
                <div className='flex flex-col items-center justify-center gap-[8px]'>
                    {
                        userData?.profile_photo === null ? (
                            ...
                            <img src={ProfilePhoto} alt='profile_photo' className='w-[142px] h-[142px]' />
                        )
                    }
                ...
                <button className=' bg-[#FBA599] border border-[#000709] rounded-[6px] py-[12px] px-[17px]'>
            ...
            <div className='w-full flex flex-col gap-[7px] '>
                ...
                <div className='w-[308px]  bg-[#fff] px-[14px] py-[18px] justify-between rounded-lg border border-[#E3E7E8] flex'>
                    <img src={Netflix} alt="Netflix" className='w-[32px] h-[32px]'/>
