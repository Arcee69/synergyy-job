    ...
    <div className='flex justify-between'>
        <div className='w-full lg:w-[669px] flex flex-col gap-[32px]'>
            ...
            <div className='w-full rounded-[8px] flex flex-col gap-[24px] border border-[#E3E7E8] bg-[#fff] px-5 py-[22px]'>
                <div className='flex justify-between '>
                    <img src={Netflix} alt='jobImages' className='w-[32px] h-[32px] lg:w-[40px] lg:h-[40px]' />
                    <div className='flex flex-col lg:w-[529px] gap-[7px]' >
                        <p className='font-mont text-sm lg:text-base font-semibold text-[#001A24]'>Software Developer/Engineer</p>
                        <p className='text-sm font-medium font-mont text-[#000D12]'>Netflix</p>
                        <div className='flex gap-[6px]'>
                            <div className='w-[38px] h-[19px] lg:w-[60px] flex items-center justify-center lg:h-[25px] rounded-[2px] border border-[#1c1c1c1a]'>
                            ...
                            <div className='w-[130px] h-[19px] lg:w-[176px] flex items-center justify-center lg:h-[25px] rounded-[2px] border border-[#1c1c1c1a]'>
                                <p className='text-[11px] lg:text-sm font-mont text-[#000D12]'>₦100,000 - ₦150,000</p>
                            </div>
                        </div>
        ...
        <div className='w-[332px] hidden lg:flex flex-col gap-6' style={{    marginRight: '-4%'}}>
            <div className='w-[308px] px-[14px] py-[18px] flex flex-col gap-[10px] bg-[#fff] border border-[#E3E7E8] rounded-lg'>
                <img src={Netflix} alt='Netflix' className='w-[48px] h-[48px]' />
                <p className='font-[13px] font-mont font-semibold text-[#001A24]'>Netflix Technologies</p>
                <div className='flex items-center'>
                    <IoLocationOutline className="text-[#00141B] w-[16px] h-[16px]" />
                    <p className='text-xs font-mont font-medium text-[#000D12]'>United States</p>
                </div>
                ...
                <div className='flex justify-end'>
                    <button className='border flex items-center rounded-[6px] px-[17px] py-[12px] border-[#001A24] '>
        ...
        <ModalPop isOpen={openApply} >
            <Apply handleClose={() => setOpenApply(false)} />
        </ModalPop>
    </div>
  )
}
