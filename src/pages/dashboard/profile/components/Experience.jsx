...
const Experience = ({ setActive }) => {
    ...
    const [forms, setForms] = useState([0]); // State to manage multiple forms
    ...
    const submitExperienceForm = (values, action) => {
        ...
        .then((res) => {
            ...
            if(res?.meta?.requestStatus === "fulfilled"){
                action.resetForm()
                localStorage.setItem("educationUnlocked", true)
                setActive(4)
            }
        })
    }
  ...
  return (
    ...
    //                     <div className='flex items-center flex-col gap-[16px] lg:flex-row '>
    //                         <div className='flex items-center gap-[14px]'>
    //                             <div className='w-full flex flex-col gap-[6px]'>
    //                                 <label htmlFor='startMonth' className='font-mont font-medium text-[#334D57] text-sm'>Start Month</label>
    //                                 <div
    //                                     className="outline-none w-full lg:w-[168px] h-[45px] flex items-center justify-between text-[#99A6AB] appearance-none  font-mont text-xs bg-[#FFF] border rounded border-[#C6C6C6] p-3 h-[38px] border-solid "
    //                                 >
    //                                 <select
    //                                     name="startMonth"
    ...
    //                                 ) : null}
    //                             </div>
    //                             <div className='w-full flex flex-col mt-[27px] gap-[6px]'>
    ...
    //                         <div className="flex items-center gap-[14px]">
    //                             <div className='w-full flex flex-col gap-[6px]'>
    //                                 <label htmlFor='endMonth' className='font-mont font-medium text-[#334D57] text-sm'>End date</label>
    //                                 <div
    //                                 className={`${check ? "bg-[#E5E5E5]" : "bg-[#FFF] border-solid border-[#C6C6C6] border"} outline-none w-full lg:w-[168px] h-[45px] flex items-center justify-between text-[#99A6AB] appearance-none font-mont text-xs rounded p-3 h-[38px]`}
    //                                 >
    //                                 <select
    //                                     name="endMonth"
    ...
    //                                 ) : null}
    //                             </div>
    //                             <div className='w-full flex flex-col lg:mt-[27px] gap-[6px]'>
    ...
    //     <button className='w-[93px] h-[32px] bg-[#FFEFE6] mt-[18px] ml-4 rounded-lg' onClick={addAnotherForm}>
    //         <p className='text-[#FDB181] text-xs font-mont font-medium'>Add Another</p>
    //     </button>
    // </div>

    <div className="flex flex-col mb-14 gap-4 mt-4">
            {forms.map((formIndex, index) => (
                <div key={index} className='w-full flex flex-col bg-[#fff] overflow-x-hidden overflow-y-hidden rounded-lg p-4' onSelect={() => setGetIndex(index)} >
                    <Formik
                        initialValues={{
                            jobTitle: "",
                            companyName: "",
                        ...
                        {({
                            ...
                            <Form onSubmit={handleSubmit} className="flex ">
                                <div className="w-full flex flex-col gap-[24px]">
                                    ...
                                    <div className='flex lg:items-center flex-col gap-[16px] lg:flex-row '>
                                        ...
                                        <div className="flex flex-col lg:flex-row lg:items-center  gap-[14px]">
                                            <div className='w-full flex flex-col gap-[6px]'>
                                                <label htmlFor='End Date' className='font-mont font-medium text-[#334D57] text-sm'>End date</label>
                                                <div
                                                className={`${check ? "bg-[#E5E5E5]" : "bg-[#FFF] border-solid border-[#C6C6C6] border"} outline-none w-full lg:w-[168px] h-[45px] flex items-center justify-between text-[#99A6AB] appearance-none font-mont text-xs rounded p-3 h-[38px]`}
                                                >
                                                <select
                                    ...
                                    <div className="flex justify-end fixed lg:right-[30%] top-[90%]">
                                        <button 
                                            className={`${isValid ? "bg-[#FDB181]" : "bg-[#BABABA]"} w-[300px] lg:w-[251px] h-[52px] rounded-[4px] border border-[#000709] bg-[#BABABA] flex justify-center items-center `}
                                            type='submit'
                                            disabled={!isValid}
                                            onClick={() => {setShowWorkExperienceInput(prev => !prev); submitExperienceForm(values, action)}}
                                        >
            ...
            <div className='flex items-center gap-2'>
                <button className='w-[93px] h-[32px] bg-[#FFEFE6] mt-[18px] ml-4 rounded-lg' onClick={addAnotherForm}>
                 ...
                 {
                    forms.length > 1 && (
                        <button className='w-[93px] h-[32px] bg-[#ccc] mt-[18px] ml-4 rounded-lg' onClick={() => removeForm(getIndex)}>
                            <p className='text-[#00141B] text-xs font-mont font-medium'>Remove</p>
                        </button>
                    )
                }
            </div>
