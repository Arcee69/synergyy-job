...
import Search from "../../../../assets/svg/search-01.svg"
    ...
    <div className="flex flex-col gap-4 mb-14 mt-4">
        <div className='w-full lg:w-[756px] overflow-x-hidden relative  bg-[#fff] rounded p-4 gap-5'>
            <div className='flex flex-col gap-[4px]'>
                <p className='text-[#1B565B] font-semibold text-base lg:text-lg'>Add Skills</p>
            ...
            <div className='border-0 border-[#E3E7E8] rounded-lg mt-[19px] lg:w-[725px] py-[14px] px-[0px]'>
                ...
                <div className='flex flex-wrap gap-2 mt-[19px] items-center'>
                    {
                       getAllTechnicalSkills?.length > 0 && getAllTechnicalSkills?.map((skills, index) => (
                        <div key={index} className='w-auto h-[36px] bg-[#EAFAFB] flex items-center gap-2 justify-between rounded-[9px] p-2'>
                            ...
                            <p 
                            className='w-[8px] h-[8px] text-[#28C9D0] mr-1 flex items-center cursor-pointer' 
                                        ...
                                        <div className='flex flex-col gap-1'>
                                            <div className='flex w-full lg:w-[392px] border rounded-lg border-[#C6C6C6] h-[40px] border-solid p-1.5'>
                                                ...
                                                <input
                                                    ...
                                                    className="outline-none w-full lg:w-[392px] ml-2 text-[#667A81] font-mont text-xs bg-[#FFF]    "
                                                />
                                            </div>
            ...
            <div className='border-0 border-[#E3E7E8] rounded-lg mt-[19px] lg:w-[725px] py-[14px] px-[12px]'>
            ...
            <div className='flex justify-end fixed lg:right-[26%] top-[90%]'>
                <button 
                    className={`${softSkillSet || technicalSkillSet ? "bg-[#FDB181] text-[#00141B]" : "bg-[#BABABA] text-[#00141B]"} w-[300px] lg:w-[251px] h-[52px] rounded-[4px] border border-[#000709] bg-[#BABABA] flex justify-center items-center`}
                    type='button'
                    onClick={() => {setActive(3), localStorage.setItem("experienceUnlocked", true)}}
                >
