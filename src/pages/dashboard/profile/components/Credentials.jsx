                    ...
                    >
                      {({
                        ...
                        <Form onSubmit={handleSubmit} className="flex ">
                            <div className="w-full flex flex-col gap-[24px]">
                                <div className='flex items-center justify-between'>
                                    <p className='text-[#00141B] font-mont text-lg font-medium'>Add Education</p>
                                </div>
                                        ...
                                        <div
                                          ...
                                          className={`${
                                            ...
                                            (values?.schoolName === ""
                                                          ...
                                                          : schoolClicked && values?.schoolName !== "")
                                              ? "hidden"
                                              : "w-[310px] p-2.5 h-[100px] bg-[#F9FAFB] overflow-y-scroll absolute p-2 top-[auto] translate-y-[50%] "
                                          }`}
                                        >
                                        {loadSchools?.map((item, index) => {
                                          return (
                                ...
                                <div className='flex lg:items-center flex-col gap-[16px] lg:flex-row '>
                                    <div className='flex flex-col lg:flex-row lg:items-center lg:gap-[14px]'>
                                        <div className='w-full flex flex-col gap-[6px]'>
                                            <label htmlFor='startMonth' className='font-mont font-medium text-[#334D57] text-sm'>Start Month</label>
                                            <div
