  ...
  return (
    <div className=' flex flex-col'>
        ...
        <div className='w-full flex overflow-x-hidden'>
            <div className='w-[818px] flex flex-col gap-12  px-5 lg:px-[103px] pt-[10px] pb-[86px]  bg-[#fff] '>
                <FaArrowLeft onClick={() => navigate(-1)} className="cursor-pointer flex items-start mt-5"/>
