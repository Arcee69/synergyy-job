...
const Level = ({ handleChangeButton }) => {
    ...
    const options = [
        {
            id: 1,
            option: "Seek mentorship"
        },
        {
            id: 2,
            option: "Pursue new opportunities "
        },
        {
            id: 3,
            option: "Pursue new opportunities"
        ...
        {
            id: 4,
            option: "Build strong relationships"
        },
    ]
    ...
    <div className="flex flex-col w-full lg:w-[632px] lg:p-10 rounded-lg lg:mt-6 bg-[#fff] lg:mx-[90px]  gap-4">
        ...
        <div className='flex justify-between mr-4'>
            ...
            <div className='flex items-center relative gap-2'>
                <p className='text-[#667A81] absolute right-2.5 text-[20px] font-mont font-semibold'>5/6</p>
                <Progress type="circle" percent={65} showInfo={false} size={52} strokeColor="#29CFD6" />
            </div>
        </div>
