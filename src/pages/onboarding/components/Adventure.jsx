...
const Adventure = ({ handleChangeButton }) => {
    ...
    const options = [
        {
            id: 1,
            option: "Climbing the corporate ladder "
        },
        {
            id: 2,
            option: "Founding your own startup "
        },
        {
            id: 3,
            option: "Exploring a new career"
        },
        {
            id: 4,
            option: "Achieving a work-life balance "
        },
    ]
    ...
    <div className="flex flex-col w-full lg:w-[632px] lg:p-10 rounded-lg lg:mt-6 bg-[#fff] lg:mx-[90px]  gap-4">
        ...
        <div className='flex justify-between mr-4'>
            ...
            <div className='flex items-center relative gap-2'>
                <p className='text-[#667A81] absolute right-2.5 text-[20px] font-mont font-semibold'>3/6</p>
                <Progress type="circle" percent={39} showInfo={false} size={52} strokeColor="#29CFD6" />
            </div>
        </div>

        <div className='w-full lg:w-[420px] flex flex-col mx-auto gap-10'>
            <p className='text-[#043246] font-semibold text-[18px] lg:text-[24px] font-mont'>Your career is an adventure—what's your ultimate quest?</p>
