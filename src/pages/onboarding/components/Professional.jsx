...
const Professional = ({ handleChangeButton }) => {
    ...
    const options = [
        {
            id: 1,
            option: "Competitive pay and benefits"
        },
        {
            id: 2,
            option: "Leadership opportunities"
        },
        {
            id: 3,
            option: "Access to learning resources"
        },
        {
            id: 4,
            option: "Positive company culture"
        },
        {
            id: 5,
    ...
    <div className="flex flex-col w-full lg:w-[632px] lg:p-10 rounded-lg lg:mt-6 bg-[#fff] lg:mx-[90px]  gap-4">
        ...
        <div className='flex justify-between mr-4'>
            ...
            <div className='flex items-center relative gap-2'>
                <p className='text-[#667A81] absolute right-2.5 text-[20px] font-mont font-semibold'>6/6</p>
                <Progress type="circle" percent={78} showInfo={false} size={52} strokeColor="#29CFD6" />
            </div>
        </div>
        ...
        <div className='w-full lg:w-[420px] flex flex-col mx-auto gap-10'>
            <p className='text-[#043246] font-semibold text-[18px] lg:text-[24px] font-mont'>
                What matters most for your professional adventure?
            </p>
