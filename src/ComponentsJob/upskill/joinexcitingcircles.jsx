    ...
    return (
        <div className='lg:px-[80px] px-[18px] lg:pt-[62px] pt-[50px] lg:pb-[98px] pb-[50px] flex lg:flex-row flex-col lg:gap-20 gap-10 items-center'>
            ...
            <div className='flex flex-col lg:gap-6 gap-3 lg:w-[50%]'>
                ...
                <p className='lg:text-justify text-center sm:text-[18px] text-[12px] text-white leading-[150%]'>Stay continuously informed and in sync with your peers on topics that you are interested in. Engage with like-minded individuals and professionals within your industry.</p>
            </div>
        </div>
    )
}
