    ...
    <div className='w-full flex  justify-between items-center'>
        <div className='cursor-pointer' onClick={() => navigate('/')}>
            <img
                src={Logo}
                alt="dunfix-logo"
                className="cursor-pointer lg:hidden xs:block w-[115px] h-[26px]"
            />
        </div>
        <div className=' flex gap-[12px] items-center' >
            <img src={Notification}  alt='notification' className='w-[44px] h-[40px]'/>
            <div className='w-[48px] h-[44px] flex justify-center items-center rounded-full border border-[#1c1c1c1a] py-[8px] py-[10px]'>
                <Button
                    id="basic-button"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="16" viewBox="0 0 22 16" fill="none">
            ...
            {/* <GiHamburgerMenu className="w-[21px] h-[16px] text-[#334D57]" onClick={() => setOpenModal(true)} /> */}
        </div>
    </div>
