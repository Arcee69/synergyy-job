...
import { top10TechnicalSkills, technicalSkills, level } from '../utils/data';
...
export default function TechnicalSkill() {
    ...
    const simulateSearch = (input) => {
        ...
        const result = technicalSkills.filter((skill) => skill.toLowerCase().includes(search));
        return result;
    }
    ...
    return (
        <Onboards full={true} rate={'w-[44.44%]'} width={true}>
            <div className='flex mb-12 items-center justify-between px-8'>
                <h1 className='capitalize text-[18px] font-medium text-white'>Add technical skills</h1>
                ...
                <div className='flex flex-col w-full gap-[26.35px] mb-10'>
                    <div className='flex flex-col gap-[19.2px]'>
                        ...
                        <div className='flex w-full gap-[10px] flex-wrap'>
                            {top10TechnicalSkills.map((skill) => {
                                return (
