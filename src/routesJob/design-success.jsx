                ...
                <div className='absolute top-[17%] w-full flex justify-center text-center'>
                    <div className='mini:border-black mini:border rounded-[40px] flex justify-center w-[651px]'>
                        <div className='mini:my-[68.6px] mini:px-[86px] px-4'>
                            <h1 className='font-bold mini:text-[36px] text-[24px] opacity-90'>Registration Successful</h1>
                            <div className='mini:mt-10 mt-6'>
                                <Rafiki className='w-full flex'/>
                                <p className='mini:mt-10 mt-6 text-center mini:text-[19px] text-[14px] font-medium opacity-80'>You’ve successfully registered for the Africa Design Quest 2023. We’ll contact you via email with the details of your quest. Best of luck.</p>
                                <p className='mt-10 text-center mini:text-[19px] text-[14px] font-medium'>Find more exciting opportunities on Synergyy</p>
